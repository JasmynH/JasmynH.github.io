...
官方网站的样式：
![](3.png)
官方文档：https://bizcharts.net/product/bizcharts/gallery
__注:__ 
环图的写法和饼图有些不同，
* DonutChart环图写法
(都是写在标签属性里,包括设置标题，图例等)
```
<DonutChart
	data={data || []}
	radius={0.8}
...
* 饼图写法
（需要两个标签，部分写在标签属性里，部分内容写在两标签中间）
```
<Chart
	height={window.innerHeight} data={dv} scale={cols} padding={[80, 100, 80, 80]} forceFit
>
